...
cap = cv2.VideoCapture("C:\\Users\\Lenovo\\Downloads\\Video12.mp4")
    ...
    for possibleC in possibleChars:
        ...
        def matchingChars(possibleC, possibleChars):
            ...
            for possibleMatchingChar in possibleChars:
                ...
                changeInWidth = float(
                    abs(possibleMatchingChar.boundingRectWidth - possibleC.boundingRectWidth)) / float(
                    possibleC.boundingRectWidth)

                changeInHeight = float(
                    abs(possibleMatchingChar.boundingRectHeight - possibleC.boundingRectHeight)) / float(
